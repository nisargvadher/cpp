Below are efficient solutions implemented using Greedy approach, Divide-and-conquer and Dynamic Programming for general practice problems which are described below:
